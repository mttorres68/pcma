...
import { setTipoUsuarioFuc } from "../localStorage"
...
export const CardTurma = ({to, curso, disciplina, monitor,...props}) =>{

    return(
        <div className="cursor-pointer">
            <NavLink to={to}  className="block rounded-md border text-start border-gray-800 bg-gray-900 p-4 shadow-xl bg-opacity-[0.7]">
                ...
                <div className="text-start p-2 rounded-md font-semibold mt-4 bg-gray-800 bg-opacity-50">
                    Monitor
